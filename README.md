...
flowchart TD
  ...
  subgraph sg_infinite_crisis["Infinite Crisis"]
    ...
    batman_a_lonely_place_of_dying --> batman_death_and_the_maidens
    batman_death_and_the_maidens --> batman_hush["Batman: Hush"]
    batman_hush --> batman_hush_returns["Batman: Hush Returns"]
    ...
    batman_hush_returns --> batman_under_the_hood
...
flowchart TD
  ...
  final_crisis --> green_lantern_rage_of_the_red_lanterns["Green Lantern: Rage of the Red Lanterns" ]
  batman_rip["Batman R.I.P."] --> batman_battle_for_the_cowl
  sinestro_corps_war["Sinestro Corps War"] --> green_lantern_rage_of_the_red_lanterns
  final_crisis --> green_lantern_corps_sins_of_the_star_sapphire["Green Lantern Corps: Sins of the Star Sapphire"]
  sinestro_corps_war --> green_lantern_corps_sins_of_the_star_sapphire
  batman_heart_of_hush["Batman: Heart of Hush"] --> batman_hush_money["Batman: Hush Money"]

  subgraph sg_flashpoint["Flashpoint"]
    batman_battle_for_the_cowl --> batman_and_robin["Batman and Robin: Batman Reborn"]
